...
const Task = () => {
  return (
    <div className='w-[90%] h-15 rounded-2xl bg-white flex justify-start items-center shrink-0'>
        ...
        <div className='xl:w-[67%] xs:w-[57%] xm:w-[63%] h-11 bg-blueDate rounded-[10px] flex justify-center items-center'>
          <h3>Go running</h3>
        </div>
